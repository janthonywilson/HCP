...
getHCP.Server = Server
getHCP.Project = 'HCP_Phase2'

getHCP = getHCP(User, Password, Timeout, TimeoutMax, TimeoutStep)
...
if (showClassUsage):
    ...
    print getHCP.fGetSessionQuality()[0]
    getHCP.Sessions = []
    getHCP.Session = []
    print getHCP.fGetSessionQuality()[0]
#    Projects = getHCP.fGetProjects()
#    Sessions, Quality, Series, ScanIds, ScanType = getHCP.fGetQuality(inputProject, 'ALL')
